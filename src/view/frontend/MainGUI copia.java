...
//         initComponents();
//         caricaAnnunciDaFile("file/annunci.csv");
//     }
...
//         resetButton.setVisible(false); // Inizialmente nascosto
//         resetButton.addActionListener(e -> ripristinaVistaCompleta());

//         // Aggiunta dei bottoni al pannello
//         bottomPanel.add(resetButton); // **Aggiunto il bottone reset**
...
//         try {
//             gestoreBacheca.salvaSuFile("file/annunci.csv");
