...
const fileDescriptions = {
    ...
    'src/bacheca/Annuncio.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/java-coffee-cup-logo.png',
    ...
    'src/bacheca/AnnuncioAcquisto.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/shopping-cart.png',
    ...
    'src/bacheca/AnnuncioVendita.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/sell.png',
    ...
    'src/bacheca/Bacheca.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/bulletin-board.png',
    ...
    'src/bacheca/Utente.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/user.png',
    ...
    'src/controller/GestoreBacheca.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/settings.png',
    ...
    'src/controller/GestoreBachecaImpl.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/gear.png',
    ...
    'src/controller/GestoreUtenti.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/user-settings.png',
    ...
    'src/controller/GestoreUtentiImpl.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/user-male-circle.png',
    ...
    'src/view/cli/MainCLI.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/terminal.png',
    ...
    'src/view/cli/StartApp.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/launch.png',
    ...
    'src/view/frontend/MainGUI.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/desktop.png',
    ...
    'src/eccezioni/BachecaException.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/error.png',
    ...
    'src/eccezioni/DatiNonValidiException.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/warning.png',
    ...
    'src/eccezioni/FileBachecaException.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/file-error.png',
    ...
    'src/eccezioni/GestoreBachecaException.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/system-error.png',
    ...
    'src/eccezioni/OperazioneNonValidaException.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/cancel.png',
    ...
    'src/test/TestAnnuncioVendita.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/test-tube.png',
    ...
    'src/test/TestUtente.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/test-results.png',
    ...
    // DATA & EXTERNAL
    'data/annunci.csv': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/csv.png',
    ...
    'docs/Progetto 24-25.pdf': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/pdf.png',
    ...
    'jbook/util/Input.java': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/keyboard.png',
    ...
    'README.md': {
        icon: 'https://img.icons8.com/ios-filled/40/000000/markdown.png',
...
function openFileModal(fileElement) {
    ...
    modalIcon.src = fileInfo.icon;
    modalIcon.alt = fileName;
